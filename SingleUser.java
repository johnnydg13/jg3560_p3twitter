...
public class SingleUser extends User implements Subject{
	...
	public void update(Subject subject) {
        newsFeed.add(0, (((SingleUser) subject).getID() + " - " + ((SingleUser) subject).getLastUpdateTime() + " : "+ ((SingleUser) subject).getLatestMessage()));
    }
	...
	public String getLastUpdated() {
		...
		if (newsFeed.size() > 0) {
            return this.newsFeed.get(this.newsFeed.size()-1);
        }
		return null;
